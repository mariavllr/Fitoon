...
public class CharacterControls : MonoBehaviour {
	...
	private bool canMove = false; //If player is not hitted. It starts stopped until a face is found
	...
	void  Start (){
		...
		if (onTesting) canMove = true;
	}
	
	bool IsGrounded (){
		//Debug.Log("is grounded: " + Physics.Raycast(transform.position, -Vector3.up, distToGround + 0.1f));
	...
	void Awake () {
		...
		FaceTrackingToMovement.onCaraNoDetectadaEvent += StopCharacter;
		FaceTrackingToMovement.onCaraDetectadaEvent += RestartCharacter;
	}
